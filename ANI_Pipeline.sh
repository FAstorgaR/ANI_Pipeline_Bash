...
# ANI pipeline completo con skani y fastANI

# -------------------- DESCOMPRESIÓN --------------------

echo "📦 Descomprimiendo archivos .fna.gz si existen..."
find "$OUTDIR" -type f -name "*.fna.gz" -exec gunzip -f {} \;

# -------------------- CREAR LISTAS DE GENOMAS --------------------

echo "📃 Generando listas de archivos .fna..."
...
# Genera archivos temporales separados para consulta y referencia (todos contra todos)
